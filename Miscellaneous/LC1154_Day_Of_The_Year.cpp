...
int dayOfYear2(string date){
	...
	int Cmonths[] = {0,31,59,90,120,151,181,212,243,273,304,334,365};
	
	return (Cmonths[month-1] + day)+(((isLeapYear(year))&&(month>2))?(1):(0));
}
...
int main(){
	...
	cout<<dayOfYear2("2019-01-09")<<endl;
	cout<<dayOfYear2("2003-03-01")<<endl;
	cout<<dayOfYear2("2004-03-01")<<endl;
	cout<<dayOfYear2("2008-10-10")<<endl;
